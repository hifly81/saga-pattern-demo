...
public class InsuranceResource {
    ...
    @POST
    @Counted(name = "performedChecks", monotonic = true, description = "Number of add insurances")
    @Timed(name = "checksTimer", description = "Add insurance duration", unit = MetricUnits.MILLISECONDS)
