package org.hifly.saga.choreography.insurance.service;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import org.hifly.saga.choreography.insurance.constant.OrderEventType;
import org.hifly.saga.choreography.insurance.constant.PaymentEventType;
import org.hifly.saga.choreography.insurance.constant.TicketEventType;
import org.hifly.saga.choreography.insurance.event.OrderEvent;
import org.hifly.saga.choreography.insurance.event.ProcessedEvent;
import org.hifly.saga.choreography.insurance.model.Insurance;
import org.hifly.saga.choreography.insurance.model.InsuranceState;
...
public class InsuranceService {
    ...
    public Insurance bookInsurance(Insurance insurance) {
        ...
        //find the insurance
        existing = findInsurancesByOrderIdAndState(insurance.getOrderId(), InsuranceState.INSURANCE_PREPARED);
        if(existing == null) {
    ...
    public void onEventReceived(String orderId, String payload) {
        ...
        if(itemEventType.equals(TicketEventType.TICKET_CREATED.name())) {
            ...
            if(Boolean.valueOf(insuranceRequired)) {
                ...
                insurance.setState(InsuranceState.INSURANCE_PREPARED);
                ...
                //create insurance
                Insurance insurance = new Insurance();
                insurance.setState(InsuranceState.INSURANCE_NOT_NEEDED);
                insurance.setOrderId(orderId);
                insurance.setAccountId(accountId);
                insurance.setTicketId(itemId);
                insurance.setTicketCost(itemCost);
