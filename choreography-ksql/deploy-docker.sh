...
docker run -d --name zookeeper -p 2181:2181 -p 2888:2888 -p 3888:3888 confluentinc/confluentinc/cp-zookeeper:6.1.0
echo -e "\nZookeeper started."

############################ Kafka
sleep 5
echo -e "\nStart Kafka container...."
docker run -d --name my-cluster-kafka-bootstrap -p 9092:9092 --link zookeeper:zookeeper confluentinc/cp-kafka:6.1.0
echo -e "\nKafka started."
